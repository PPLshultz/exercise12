...
public class Parser {
   ...
   public Node parseDef() {
      ...
      if (token.matches("RPAREN", ")")) {
         ...
         return new Node("def", varName, first, second, null);
      }
   } // parseDef()
   ...
   private Node parseParams() {
      ...
      if (token.matches("RPAREN", ")")) {
         ...
         return new Node("NAME", varName, null, null, null);
      }
      else { //else there are <params>
         lex.putBackToken(token);
         Node first = parseParams();
         // return new Node( "NAME", first, null, null );
         return new Node("NAME", varName, first, null, null);
      }
   } // parseParams()
